...
// ============================================================
const serviceAccount = require('./radar-26442-firebase-adminsdk-fbsvc-5426beff75.json');
...
function processarAtualizacaoJogo(jogoData) {
    ...
    let bodyParts = [];
    if (jogoData.acrescimoHT > 0) bodyParts.push(`⏱️ HT: +${jogoData.acrescimoHT} min`);
    if (jogoData.acrescimoFT > 0) bodyParts.push(`⏱️ FT: +${jogoData.acrescimoFT} min`);
